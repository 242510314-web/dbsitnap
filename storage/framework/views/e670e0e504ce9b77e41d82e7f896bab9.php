...
<div class="row">
    ...
    <form method="POST" action="<?php echo e(route('itempenjualan.store')); ?>" class="row mb-2">
        ...
        <div class="col-7">
            ...
            <div class="btn btn-outline-primary w-100 text-start p-2 <?php echo e($sale->status === 'COMPLETED' ? 'disabled' : ''); ?>">
        ...
        <div class="col-2">
            <button type="submit" class="btn btn-primary w-100 <?php echo e($sale->status === 'COMPLETED' ? 'disabled' : ''); ?>">+</button>
        </div>
    </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\siti\dbsitnap\resources\views\penjualan\pos.blade.php ENDPATH**/ ?>